...
public class Fragment_Update extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        et_name = (EditText)v.findViewById(R.id.et_name);   et_name.setVisibility(View.VISIBLE); et_name.setText("New name");
        tv_title = (TextView)v.findViewById(R.id.tv_form_title);    tv_title.setText("UPDATE USER");
        tv_response = (TextView)v.findViewById(R.id.tv_response_create);
        btn_update = (Button)v.findViewById(R.id.btn_create); btn_update.setText("UPDATE");
    ...
    public void updateUser(String eml, String first_name) {
        ...
        Log.d("OBJETO A ACTUALIZAR: ", jobject.toString());
                ...
                new JsonObjectRequest(
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                tv_response.setText("USUARIO ACTUALIZADO CON EXITO\n\n"+response.toString());
                                Log.e("PETICION CORRECTA", "ACTUALIZADO CON EXITO");
                            }
                        },
